...
| adminConfig.VERSION | string | `"3.0.0-beta7"` |  |
...
| portal.frontend.image.tag | string | `"3.0.0-beta7"` |  |
...
| portal.server.authServer.image.tag | string | `"3.0.0-beta7"` |  |
...
| portal.server.graphqlServer.genericEnv.WORKFLOW_HELPER_IMAGE_VERSION | string | `"3.0.0-beta7"` |  |
...
| portal.server.graphqlServer.image.tag | string | `"3.0.0-beta7"` |  |
...
| portal.server.graphqlServer.imageEnv.EVENT_TRACKER_IMAGE | string | `"litmusportal-event-tracker:3.0.0-beta7"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_EXPORTER_IMAGE | string | `"chaos-exporter:3.0.0-beta7"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_OPERATOR_IMAGE | string | `"chaos-operator:3.0.0-beta7"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_RUNNER_IMAGE | string | `"chaos-runner:3.0.0-beta7"` |  |
| portal.server.graphqlServer.imageEnv.SUBSCRIBER_IMAGE | string | `"litmusportal-subscriber:3.0.0-beta7"` |  |
...
| portal.server.waitForMongodb.image.tag | string | `"3.0.0-beta7"` |  |
...
| upgradeAgent.controlPlane.image.tag | string | `"3.0.0-beta7"` |  |
