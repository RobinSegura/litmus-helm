...
![Version: 3.0.0](https://img.shields.io/badge/Version-3.0.0-informational?style=flat-square) ![AppVersion: 3.0.0-beta8](https://img.shields.io/badge/AppVersion-3.0.0--beta8-informational?style=flat-square)
...
| adminConfig.VERSION | string | `"3.0.0-beta8"` |  |
...
| ingress.tls | list | `[]` |  |
| mongodb | object | `{"architecture":"standalone","auth":{"enabled":true,"existingSecret":"","rootPassword":"superhardpassword"},"enabled":true,"metrics":{"enabled":false,"prometheusRule":{"enabled":false}},"replicaCount":1,"useStatefulSet":true}` | Configure the Bitnami MongoDB subchart see values at https://github.com/bitnami/charts/blob/master/bitnami/mongodb/values.yaml |
...
| portal.frontend.image.tag | string | `"3.0.0-beta8"` |  |
...
| portal.server.authServer.image.tag | string | `"3.0.0-beta8"` |  |
...
| portal.server.graphqlServer.genericEnv.HUB_BRANCH_NAME | string | `"v3.0.0-beta3"` |  |
...
| portal.server.graphqlServer.genericEnv.WORKFLOW_HELPER_IMAGE_VERSION | string | `"3.0.0-beta8"` |  |
...
| portal.server.graphqlServer.image.tag | string | `"3.0.0-beta8"` |  |
...
| portal.server.graphqlServer.imageEnv.EVENT_TRACKER_IMAGE | string | `"litmusportal-event-tracker:3.0.0-beta8"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_EXPORTER_IMAGE | string | `"chaos-exporter:3.0.0-beta8"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_OPERATOR_IMAGE | string | `"chaos-operator:3.0.0-beta8"` |  |
| portal.server.graphqlServer.imageEnv.LITMUS_CHAOS_RUNNER_IMAGE | string | `"chaos-runner:3.0.0-beta8"` |  |
| portal.server.graphqlServer.imageEnv.SUBSCRIBER_IMAGE | string | `"litmusportal-subscriber:3.0.0-beta8"` |  |
...
| portal.server.waitForMongodb.image.tag | string | `"3.0.0-beta8"` |  |
...
| upgradeAgent.controlPlane.image.tag | string | `"3.0.0-beta8"` |  |
