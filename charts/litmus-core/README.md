...
![Version: 3.0.0-beta8](https://img.shields.io/badge/Version-3.0.0--beta8-informational?style=flat-square) ![AppVersion: 3.0.0-beta8](https://img.shields.io/badge/AppVersion-3.0.0--beta8-informational?style=flat-square)
...
| exporter.image.tag | string | `"3.0.0-beta8"` |  |
...
| operator.image.tag | string | `"3.0.0-beta8"` |  |
...
| runner.image.tag | string | `"3.0.0-beta8"` |  |
| service.port | int | `80` |  |
